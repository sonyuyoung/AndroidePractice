...
import com.example.myapp_test6_syytest.ch18_Test.model.newsModel.ItemModel
...
class MyViewHolderRetrofit2(val binding: ItemRetrofit2Binding) :
...
class MyAdapterRetrofit2(val context: Context, val datas: MutableList<ItemModel>?) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        var binding = (holder as MyViewHolderRetrofit2).binding
