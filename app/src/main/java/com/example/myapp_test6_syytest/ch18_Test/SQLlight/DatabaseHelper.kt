package com.example.myapp_test6_syytest.ch18_Test.SQLlight
...
class DatabaseHelper(context: Context?) : SQLiteOpenHelper
    ...
    fun updateData(id: String, email: String, name: String, password: String, phone: String, address: String,profileUrl:String?): Boolean {
        val db = this.writableDatabase
        val contentValues = ContentValues()
        contentValues.put(COL_1, id)
        contentValues.put(COL_2, email)
